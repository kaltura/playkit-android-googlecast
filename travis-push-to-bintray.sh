...
if ! grep -q "ext.libVersion = '$TAG_VERSION_NAME'" googlecast/version.gradle
then
...
# Upload
./gradlew googlecast:bintrayUpload -PdryRun=$DRY_RUN -PbintrayUser=$BINTRAY_USER -PbintrayKey=$BINTRAY_KEY
